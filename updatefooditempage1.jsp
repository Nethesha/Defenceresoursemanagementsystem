			...
			<div class="row">
				...
				<div class="col-lg-6 form_col">
					<div class="contact_form_container">
						<form action="updatefooditemdata1.jsp" id="contact_form" class="contact_form" method="post">
							<div class="row">
							...
							<div class="input_container"><input type="text" class="contact_input" placeholder="Enter canteen" name="canteen" required="required" value="<%= session.getAttribute("rname").toString() %>" readonly></div>
