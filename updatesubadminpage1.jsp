			...
			<div class="row">
				...
				<div class="col-lg-6 form_col">
					<div class="contact_form_container">
						<form action="updatesubadmindata1.jsp" id="contact_form" class="contact_form" method="post">
							<div class="row">
							...
							<div class="input_container"><input type="password" class="contact_input" placeholder="Password" name="password" value="<%= password %>" required="required"></div>
