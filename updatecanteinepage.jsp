...
try
{
	...
	ResultSet rs=st.executeQuery("select * from canteine where Id="+id);
	int count=0; 
	while(rs.next()) 
	{
		int id1=rs.getInt(1);
	...
	<div class="contact">
		<div class="container">
			<div class="row">
				...
				<!-- Contact Info -->
				<div class="col-lg-6">
					<div class="section_title"><h2>CANTEINE UPDATE</h2></div>
				...
				<div class="col-lg-6 form_col">
					<div class="contact_form_container">
						<form action="updatecanteinedata.jsp" id="contact_form" class="contact_form" method="post">
							<div class="row">
							...
							<div class="input_container"><input type="text" class="contact_input" placeholder="Enter Canteine Name" name="name" value="<%=name %>" required="required"></div>
							...
							<div class="input_container"><input type="text" class="contact_input" placeholder="Enter Services" name="timings"  value="<%=timings %>"  required="required"></div>					
