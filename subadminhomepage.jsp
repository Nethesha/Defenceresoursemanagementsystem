					...
					<div class="col">
						<div class="header_content d-flex flex-row align-items-center justify-content-start">
							<nav class="main_nav ml-auto">
								<ul>
									<li><a href="subadminchangepasswordpage.jsp">Change Password</a>
									
																		</li>
									<li><a href="viewsubadmindetailsdata1.jsp">View Details</a>
									
									</li>
									
									<li><a href="viewhospitaldetailsdata1.jsp">View Hospitals</a>
									
									</li>
									
									<li><a href="viewcanteinedetailsdata1.jsp">View Canteens</a>
																		
									</li>
									
									
									<li><a href="viewcustomerdetailsdata2.jsp">View Customers</a>
	...
	<div class="contact">
		<div class="container">
			<div class="row">
				...
				<!-- Contact Info -->
				<div class="col-lg-6">
					<div class="section_title"><h2>SUB-ADMIN HOME</h2></div>
